...
async function testPaymentProcessing() {
  ...
  try {
    ...
    console.log(`✓ Created gift certificate: ${testGiftCert.code} with balance $${testGiftCert.balance}`)
    ...
    if (parseFloat(giftCert.balance.toString()) !== 100.00) {
    ...
    console.log('\nTest 7: Verify audit log completeness...')
    const requiredActions = ['source_selected', 'gift_certificate_payment_attempt', 'gift_certificate_payment_succeeded']
